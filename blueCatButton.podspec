...
corner radius, highlight effect, click animation, and countdown support.
  DESC
  s.homepage     = "https://example.com/blueCatButton"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author       = { "xiangduojia" => "xiangduojia@example.com" }
  s.source       = { :git => "https://example.com/blueCatButton.git", :tag => s.version.to_s }
  s.platform     = :ios, "12.0"
  s.swift_version = "5.0"
